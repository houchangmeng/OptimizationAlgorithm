...
typedef std::function<bool(Eigen::VectorXd &, Eigen::VectorXd &,
                           Eigen::MatrixXd &)>
...
public:
  UnconstraintSolver(ObjectiveFunction objective_func,
  ...
  bool Solve();
  std::vector<Eigen::VectorXd> get_solution_trajectory() {
    return x_solution_traj_;
  };

  ~UnconstraintSolver();
};

bool gradient_step_with_linesearch(Eigen::VectorXd &x, Eigen::VectorXd &grad,
                                   Eigen::MatrixXd &hess,
                                   LineSearchFunction linesearch_func,
                                   GradientFunction gradient_func,
                                   HessianFunction hessian_func);

bool gauss_newton_step_with_linesearch(Eigen::VectorXd &x,
                                       Eigen::VectorXd &grad,
                                       Eigen::MatrixXd &hess,
                                       LineSearchFunction linesearch_func,
                                       GradientFunction gradient_func,
...
bool bfgs_newton_step_with_linesearch(Eigen::VectorXd &x, Eigen::VectorXd &grad,
                                      Eigen::MatrixXd &B,
                                      LineSearchFunction linesearch_func,
                                      GradientFunction gradient_func,
                                      HessianFunction hessian_func);

bool dfp_newton_step_with_linesearch(Eigen::VectorXd &x, Eigen::VectorXd &grad,
                                     Eigen::MatrixXd &G,
                                     LineSearchFunction linesearch_func,
                                     GradientFunction gradient_func,
                                     HessianFunction hessian_func);

bool conjugate_gradient_step_with_linesearch(Eigen::VectorXd &x,
                                             Eigen::VectorXd &grad,
